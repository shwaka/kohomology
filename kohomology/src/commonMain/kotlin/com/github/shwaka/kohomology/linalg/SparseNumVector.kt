...
public class SparseNumVectorSpace<S : Scalar> private constructor(
    ...
    override val context: NumVectorContext<S, SparseNumVector<S>> = NumVectorContextImpl(this)
    ...
    override fun innerProduct(numVector1: SparseNumVector<S>, numVector2: SparseNumVector<S>): S {
        if (numVector1 !in this)
            throw IllegalContextException("The sparseNumVector $numVector1 does not match the context")
        if (numVector2 !in this)
            throw IllegalContextException("The sparseNumVector $numVector2 does not match the context")
