...
private class DividedFreeLoopSpaceFactory<I : IndeterminateName, D : Degree, S : Scalar, V : NumVector<S>, M : Matrix<S, V>>(
    ...
    val pathGAlgebraInclusion1: GAlgebraMap<GeneralizedMonomial<CopiedName<I, D>, D>, GeneralizedMonomial<CopiedName<I, D>, D>, D, S, V, M>
    val pathGAlgebraInclusion2: GAlgebraMap<GeneralizedMonomial<CopiedName<I, D>, D>, GeneralizedMonomial<CopiedName<I, D>, D>, D, S, V, M>

    val loopSpaceDGAlgebra: FreeDGAlgebra<CopiedName<I, D>, D, S, V, M> by lazy { FreeLoopSpace(freeDGAlgebra) }
    val gAlgebraProjection1: GAlgebraMap<GeneralizedMonomial<CopiedName<I, D>, D>, GeneralizedMonomial<CopiedName<I, D>, D>, D, S, V, M> by lazy {
    ...
    val gAlgebraProjection2: GAlgebraMap<GeneralizedMonomial<CopiedName<I, D>, D>, GeneralizedMonomial<CopiedName<I, D>, D>, D, S, V, M> by lazy {
        val n = freeDGAlgebra.gAlgebra.indeterminateList.size
        val loopSpaceGeneratorList = this.loopSpaceDGAlgebra.gAlgebra.generatorList
        val zeroGVector = this.loopSpaceDGAlgebra.context.run { zeroGVector }
        this.dividedLoopSpaceGAlgebra.getGAlgebraMap(
...
class DividedFreeLoopSpace<I : IndeterminateName, D : Degree, S : Scalar, V : NumVector<S>, M : Matrix<S, V>> private constructor(
    ...
    val projection1: DGAlgebraMap<GeneralizedMonomial<CopiedName<I, D>, D>, GeneralizedMonomial<CopiedName<I, D>, D>, D, S, V, M> by lazy {
        DGAlgebraMap(
            source = this,
    ...
    val projection2: DGAlgebraMap<GeneralizedMonomial<CopiedName<I, D>, D>, GeneralizedMonomial<CopiedName<I, D>, D>, D, S, V, M> by lazy {
        DGAlgebraMap(
            source = this,
            target = this.factory.loopSpaceDGAlgebra,
