...
class LinearMap<BS : BasisName, BT : BasisName, S : Scalar, V : NumVector<S>, M : Matrix<S, V>> private constructor(
    private val matrixSpace: MatrixSpace<S, V, M>,
    val source: VectorSpace<BS, S, V>,
    ...
    fun kernelBasis(): List<Vector<BS, S, V>> {
    ...
    companion object {
        fun <BS : BasisName, BT : BasisName, S : Scalar, V : NumVector<S>, M : Matrix<S, V>> getZero(
        ...
        fun <B : BasisName, S : Scalar, V : NumVector<S>, M : Matrix<S, V>> getId(
        ...
        fun <BS : BasisName, BT : BasisName, S : Scalar, V : NumVector<S>, M : Matrix<S, V>> fromMatrix(
            source: VectorSpace<BS, S, V>,
            target: VectorSpace<BT, S, V>,
            matrixSpace: MatrixSpace<S, V, M>,
            matrix: M
        ...
        fun <BS : BasisName, BT : BasisName, S : Scalar, V : NumVector<S>, M : Matrix<S, V>> fromVectors(
            source: VectorSpace<BS, S, V>,
            target: VectorSpace<BT, S, V>,
            matrixSpace: MatrixSpace<S, V, M>,
