...
describe("useIdealEditor", () => {
  test("empty text as generator", async () => {
    ...
    const testContainerProps: TestContainerProps = {
      useIdealEditorArgs: {
        validateGenerator: vi.fn().mockResolvedValue(true),
        validateGeneratorArray: vi.fn().mockResolvedValue(true),
      },
      closeDialog: vi.fn(),
    }
  ...
  test("parse error", async () => {
    ...
    const testContainerProps: TestContainerProps = {
      useIdealEditorArgs: {
        validateGenerator: vi.fn().mockResolvedValue(errorMessage),
        validateGeneratorArray: vi.fn().mockResolvedValue(true),
      },
      closeDialog: vi.fn(),
    }
  ...
  test("global error", async () => {
    ...
    const testContainerProps: TestContainerProps = {
      useIdealEditorArgs: {
        validateGenerator: vi.fn().mockResolvedValue(true),
        validateGeneratorArray: vi.fn().mockResolvedValue(errorMessage),
      },
      closeDialog: vi.fn(),
    }
    render(<TestContainer {...testContainerProps} />)
